...
| `only`                     | If `create-github-releases`, only attempt to create releases. This is useful if splitting release tagging from PR creation. If `update-pull-requests` only attempt to create release pull requests. If `list-candidate-releases`, only output information about which packages would be released.. If `list-pull-requests`, only output information about which pull requests would be created. |
...
> When used with `only: 'list-pull-requests'`, the following properties are available.

| output             | description                                                                                                                                                                       |
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `prs_pending`      | `true` if any release is pending, `false` otherwise                                                                                                                               |
| `pr`               | A JSON string of the [ReleasePullRequest  object](https://github.com/googleapis/release-please/blob/main/src/release-pull-request.ts#L20) (unset if no release created)           |
| `prs`              | A JSON string of the array of [ReleasePullRequest  objects](https://github.com/googleapis/release-please/blob/main/src/release-pull-request.ts#L20) (unset if no release created) |
